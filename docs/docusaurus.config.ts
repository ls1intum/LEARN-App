...
const config: Config = {
  ...
  projectName: 'learn-app', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/ls1intum/learn-app/tree/main/docs',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/ls1intum/learn-app',
          label: 'GitHub',
          position: 'right',
        },
      ],
